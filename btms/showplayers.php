...
<html>
	<head>
		<title>Showing All Player Details</title>
		<meta charset="utf-8" />
...
<th>Modify</th></tr>	
				...
				$query = "SELECT player_id,f_name,l_name,height,dob,pos_name from `players`";
				...
				if (mysqli_num_rows($result)>0){
					...
					<td><?php echo "<a href=deleteplayers.php?player_id=".$row['player_id'].">Delete</a> &nbsp&nbsp&nbsp  
					                <a href=updateplayers.php?player_id=".$row['player_id']." & f_name=".$row['f_name']."									
									& l_name=".$row['l_name']." & height=".$row['height']." & dob=".$row['dob']."
									& pos_name=".$row['pos_name'].">Update</a>";?></td>
